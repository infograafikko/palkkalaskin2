    ...
    d3.csv("data/palkkadata4.csv", function(error, data) {      
      ...
      function drawFirstTime() {
        ...
        function dragged(d) {
          ...
          d3.select(this).select(".draggingBox").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)");
          d3.select(this).select(".userSalaryRect").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)");
          d3.select(this).select(".userSalaryLine").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)");
          d3.select(this).select(".userSalaryText").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)").text(toolTipSalaryText);
          d3.select(this).select(".userPctText").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)").attr("y", y(circlePct) + 5).text(circlePctText + " %");
          d3.select(this).select(".userSalaryCircle").attr("transform", "translate(" + (d3.event.x - 240) + ", 0)").attr("cy", y(circlePct));
